const balancerErrorCodes: Record<string, string> = {
  ...
  '431': 'TIMELOCK_OPERATION_ALREADY_SCHEDULED',
  '432': 'TIMELOCK_OPERATION_INSUFFICIENT_DELAY',
  '433': 'TIMELOCK_OPERATION_CANNOT_BE_CANCELED',
  '434': 'TIMELOCK_MISSING_DEPENDENCY',
  '435': 'TIMELOCK_OPERATION_NOT_READY',
  '436': 'TIMELOCK_UNDERLYING_TRANSACTION_REVERTED',
  '437': 'CALLER_MUST_BE_TIMELOCK',  
  '500': 'INVALID_POOL_ID',
  '501': 'CALLER_NOT_POOL',
