/*
    ...
    This Library is a simplified version of BalanceAllocation.sol, written for verification.
    It is NOT intended to be used in production!

    Bit operations are difficult to the prover. We decided on the following abstraction:
    - Managed = 0
    - Block number = 0
    The total is equal to cash. We get it by simple casting.

    We ignore two token pools.

    All documentation below is original.
*/
...
library BalanceAllocation {
    ...
    function setManaged(bytes32 balance, uint256 newManaged) internal view returns (bytes32) {
        ...
        return balance; // Managed is zero!
    }
    ...
    function _pack(
        ...
        return bytes32(_leastSignificant); // the least significant bits include the cash
    }
}
