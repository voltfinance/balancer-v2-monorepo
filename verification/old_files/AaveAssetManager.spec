...
invariant target_percentage_less_than_one()
	Harness_getTargetPercentage() <= Harness_getMaxTargetInvestment()
		
invariant legal_config()
	Harness_getUpperCriticalPercentage() >= Harness_getTargetPercentage() && Harness_getTargetPercentage() >= Harness_getLowerCriticalPercentage()
