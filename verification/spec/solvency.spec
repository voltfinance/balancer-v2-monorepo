...
rule sum_of_internal_balance_less_than_vault_funds {
    ...
    require f.selector != Harness_singleJoinPool(bytes32,address,address,address,uint256, bool).selector;
    require f.selector != Harness_singleExitPool(bytes32,address,address,address,uint256, bool).selector;
...
// rule only_one_pool_balance_changes_if_not_batch_swap {
//     address token = ERC20.myAddress();
